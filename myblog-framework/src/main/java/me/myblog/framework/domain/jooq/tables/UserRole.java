...
public class UserRole extends TableImpl<UserRoleRecord> {
    ...
    /**
     * The reference instance of <code>myblog.user_role</code>
     */
    ...
    /**
     * The column <code>myblog.user_role.user_id</code>. 用户ID
     */
    ...
    /**
     * The column <code>myblog.user_role.role_id</code>. 角色ID
     */
    ...
    private UserRole(Name alias, Table<UserRoleRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("用户和角色关联表"), TableOptions.table());
    }

    /**
     * Create an aliased <code>myblog.user_role</code> table reference
     */
    ...
    /**
     * Create a <code>myblog.user_role</code> table reference
     */
    public UserRole() {
