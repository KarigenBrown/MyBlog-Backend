...
insert into `article`(`id`, `title`, `content`, `summary`, `category_id`, `thumbnail`, `is_top`, `status`,
                      `view_count`, `is_comment`, `create_by`, `create_time`, `update_by`, `update_time`)
values (1, 'SpringSecurity从入门到精通',
       ...
       (5, 'sdad',
        ...
        NULL, 2, '', '1', '0', 44, '0', NULL, '2022-01-17 14:58:37', NULL, NULL);
